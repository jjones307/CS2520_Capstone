...
def main():
    ...
    try:
        ...
        counts = [vowel_frequency, consonant_frequency, vowel_group_frequency, consonant_group_frequency,
                  rel_frequencies]
        c_index = 0
    ...
    user_input = [char for char in user_input if
                  char in string.ascii_lowercase or char in vowels or char in special_characters or char == " "]
    ...
    while i < len(user_input):
        if user_input[i] == " ":
            ...
            if i == len(user_input) - 1:
                ...
                if user_input[i + 1] in vowels or (user_input[i + 1] not in string.ascii_lowercase and user_input[
                    i + 1] not in special_characters):
                    try:
                        consonant_counts[user_input[i]] += 1
                    except KeyError:
                        consonant_counts[user_input[i]] = 1
                    ...
                    j = i + 1
                    while j < len(user_input) and user_input[j] not in vowels and (
                            user_input[j] in string.ascii_lowercase or user_input[j] in special_characters):
